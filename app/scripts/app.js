...
angular.module('prophet')
	...
	.constant('RouteMap', [
		...
		{name: 'recipient-list', path: '/recipients', templateUrl: 'views/recipients/list.html',
			controller: 'RecipientListCtrl', access: 'user'},
		{name: 'recipient-files', path: '/recipients/uploads', templateUrl: 'views/recipients/uploads.html',
			controller: 'RecipientUploadListCtrl', access: 'user'},
		{name: 'recipient-import', path: '/recipients/zips/:id/import', templateUrl: 'views/recipients/import.html',
			controller: 'RecipientImportCtrl', access: 'user', resolve : RecipientImportCtrl.resolve},
